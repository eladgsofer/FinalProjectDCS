...
//---------------------------------------------------------------------------------------------------------------------
/*
 * This function initialises hardware components, global flags and global variables
 */
//---------------------------------------------------------------------------------------------------------------------
void InitApp(void)
{
...
//--------------------------------------------------------------------------------------------------------------------
/*
 * This function clears LCD, resets global flags and variables before the MCU switches to IDLE mode
 */
//---------------------------------------------------------------------------------------------------------------------
void exit_state()
{
...
//------------------------------------------------------------------------------------------------------------------
/*
 * Executes Radar Detector - scans surrounding between 0 to 180 degrees
 */
//---------------------------------------------------------------------------------------------------------------------
void rad_detect(){
	int exit = 0;
...
//------------------------------------------------------------------------------------------------------------------
/*
 * Telemetry mode - rotates servo to the asked degree and start the sensor 
 */
//---------------------------------------------------------------------------------------------------------------------
void telemeter(void){
...
//---------------------------------------------------------------------------------------------------------------------
/*
 * Translates the received script into action and executes the commands
 */
//---------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------------------------------
/*
 * Sends acknowledge to PC and configures the UART according to the requrments
 */
//---------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------------------------------
/*
 * Rotates Script menu on LCD (depending on push buttons) and executes the selected script.
 * Exits when gets "Exit" from PC (Stop button pressed in GUI) 
 */
//---------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------------------------------
/*
 * Receives file from PC, when transfer is done executes received script 
 */
//---------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------------------------------
// Script receive and save
//---------------------------------------------------------------------------------------------------------------------
/*
 * Saves script's name, size, and configures DMA with source and destination.
...
//---------------------------------------------------------------------------------------------------------------
/*
 * Decodes state depending on message received from PC
 */
//---------------------------------------------------------------------------------------------------------------------
void state_decode(){
